...
import { Activity, ActivityFormValues, IUserActivity } from "../models/activity";
...
const Account = {
    ...
    googleLogin: (accessToken: string) => requests.post<User>('/account/google?accessToken=' + accessToken, {})
}
